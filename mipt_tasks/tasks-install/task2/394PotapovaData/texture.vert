...
layout(location = 2) in vec2 vertexTexCoord0; //текстурные координаты вершины
layout(location = 3) in vec2 vertexTexCoord1; //текстурные координаты вершины
...
out vec2 texCoord1; //текстурные координаты
